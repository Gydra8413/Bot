...
def send_message(message):
	if message.text == 'Москва':
		...
		bot.send_message(message.chat.id,'После оплаты вам поступит смс уведомление на указанный вами номер. Оплата осуществляется  через qiwi терминал пополнением яндекс кошелька или переводом на номер карты 4100 1151 0476 2539. В комментарии укажите ваш номер телефона и выбранный товар')
	elif message.text == 'Марихуана 0.5гр-1099':
		bot.send_message(message.chat.id,'После оплаты вам поступит смс уведомление на указанный вами номер. Оплата осуществляется  через qiwi терминал пополнением яндекс кошелька или переводом на номер карты 4100 1151 0476 2539. В комментарии укажите ваш номер телефона и выбранный товар')
	elif message.text == 'Амфетамин 1гр-1199':
		bot.send_message(message.chat.id,'После оплаты вам поступит смс уведомление на указанный вами номер. Оплата осуществляется  через qiwi терминал пополнением яндекс кошелька или переводом на номер карты 4100 1151 0476 2539. В комментарии укажите ваш номер телефона и выбранный товар')
	elif message.text == 'Метамфетамин 1гр-2199':
		bot.send_message(message.chat.id,'После оплаты вам поступит смс уведомление на указанный вами номер. Оплата осуществляется  через qiwi терминал пополнением пополнением яндекс кошелька или переводом на номер карты 4100 1151 0476 2539. В комментарии укажите ваш номер телефона и выбранный товар')
