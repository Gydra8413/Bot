...
def send_message(message):
	if message.text == 'Комсомольская улица':
 	...
 	elif message.text == 'Выберите улицу':
...
# 		bot.send_message(message.chat.id,'Выберите товар', reply_markup=markup4)
		...
		bot.send_message(message.chat.id,'После оплаты вам в телеграмме поступит смс  с фото o местонахождени товара. Оплата осуществляется  через qiwi терминал пополнением яндекс кошелька или переводом на номер карты 4100 1151 0476 2539. В комментарии укажите ваш аккаунт в телеграмме и выбранный товар', reply_markup=markup1)
